...
<!--              //上下滚动-->
                <div class="bulletin-toBottom auto-line-between">
                    <div class="content ">
                        ...
                        <transition-group name="bulletinShow" mode="in-out" tag="div"
                                          style="display: flex;flex-direction: column;">
                            <div class="text-content auto-line-start " v-for="(item,index) in bulletinData " :key="index+20" v-show="bulletin == index">
...
<style lang="scss" scoped>
    ...
    //关闭动画
    .bulletinShow-enter, .bulletinShow-leave-to {
